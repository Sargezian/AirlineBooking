...
public class ResetImpl implements ResetDao
{
    ...
    private String sqlstatement = "DROP SCHEMA IF EXISTS Sep2 CASCADE;\n" + "\n"
        + "CREATE SCHEMA Sep2;\n" + "SET SCHEMA 'sep2';\n" + "\n"
        ...
        + "\n" + "-- where not in\n" + "\n"
        + "CREATE OR replace FUNCTION updataversioning2()\n"
        + "returns TRIGGER\n" + "LANGUAGE plpgsql\n" + "AS\n" + "    $$\n"
        + "    BEGIN\n" + "        raise notice ', Before 1. if ';\n"
        + "     if ( (select count(*) from seat where old.planeID = planeID)  <1)\n"
        + "      then delete  from flights where flights.planeID  = old.planeID;\n"
        + "raise notice ', After 1. if  ';\n" + "    end if;\n"
        + "     return new;\n" + "     end;\n" + "    $$;\n" + "\n"
        + "CREATE TRIGGER Updateversioning2 after delete  On seat\n"
        + "    FOR EACH ROW EXECUTE PROCEDURE updataversioning2();\n" + "\n"
